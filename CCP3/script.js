...
ScrollReveal({
  ...
  ScrollReveal().reveal('.divh1, .h2music, .titlleartist, .nos-atouts, .section-title', { delay: 50, origin: 'top' });
  ScrollReveal().reveal('.imgmusic, .grid1', { delay: 600, origin: 'bottom' });
  ScrollReveal().reveal('.textbanner, .listeplaylist, .grid2, .cardtarifs, .text-box', { delay: 700, origin: 'top' });
